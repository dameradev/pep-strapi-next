...
export interface ApiApplicantApplicant extends Schema.CollectionType {
  ...
  attributes: {
    name: Attribute.String;
    reasonForApplication: Attribute.RichText;
    ...
    project: Attribute.Relation<
      ...
      'api::project.project'
    >;
    dietaryPreference: Attribute.Enumeration<['carnivore']>;
    createdAt: Attribute.DateTime;
    updatedAt: Attribute.DateTime;
...
export interface ApiProjectQuestionProjectQuestion
  extends Schema.CollectionType {
  collectionName: 'project_questions';
  info: {
    singularName: 'project-question';
    pluralName: 'project-questions';
    displayName: 'projectQuestion';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    applicant: Attribute.Relation<
      'api::project-question.project-question',
      'oneToOne',
      'api::applicant.applicant'
    >;
    project: Attribute.Relation<
...
declare module '@strapi/types' {
  export module Shared {
    export interface ContentTypes {
      ...
      'api::project-question.project-question': ApiProjectQuestionProjectQuestion;
